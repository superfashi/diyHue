...
class Light():
    ...
    def getV2Api(self):
        ...
        # color lights only
        if self.modelid in ["LST002", "LCT001", "LCT015", "LCX002", "915005987201", "LCX004", "LCX006", "LCA005", "LLC010", "LCG001", "LCE003"]:
    ...
    def dynamicScenePlay(self, palette, index):
        ...
        while self.dynamics["status"] == "dynamic_palette":
            ...
            if self.modelid in ["LCT001", "LCT015", "LST002", "LCX002", "915005987201", "LCX004", "LCX006", "LCA005", "LCE003"]:
